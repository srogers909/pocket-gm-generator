...
void main() {
  // Create an instance of the player generator
  final generator = PlayerGenerator();
  
  print('🏈 Pro Football Player Generator Demo 🏈\n');
  print('=' * 50);
